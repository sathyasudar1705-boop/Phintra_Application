  ...
  if (success) {
    return (
      <div style={{ textAlign: 'center', animation: 'fadeIn 0.3s ease-out' }}>
        ...
        <Link to="/login" className="btn btn-primary" style={{ width: '100%', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
          <ArrowLeft size={16} />
          Back to Sign In
        </Link>
      </div>
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <Link to="/login" style={{ fontWeight: '600', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
          Sign In
        </Link>
      </div>
    </div>
